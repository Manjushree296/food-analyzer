"""
Ultra-Fast Food Safety Model Training
Uses transfer learning with frozen backbone for fastest training
"""
...
def train_simple():
    print("\n" + "="*60)
    print("🚀 ULTRA-FAST FOOD SAFETY MODEL TRAINING")
    print("="*60 + "\n")
    ...
    # Loss and optimizer (only optimize new head)
    ...
    with open("training_metrics.txt", "w") as f:
        ...
        f.write("="*60 + "\n\n")
        f.write(f"Model Type:               ResNet18 (Transfer Learning)\n")
        ...
        f.write(f"-" * 60 + "\n")
        f.write(f"True Positive Rate:       {100*cm[1,1]/(cm[1,0]+cm[1,1]):.2f}%\n")
        f.write(f"True Negative Rate:       {100*cm[0,0]/(cm[0,0]+cm[0,1]):.2f}%\n")
        f.write(f"False Positive Rate:      {100*cm[0,1]/(cm[0,0]+cm[0,1]):.2f}%\n")
        f.write(f"False Negative Rate:      {100*cm[1,0]/(cm[1,0]+cm[1,1]):.2f}%\n")
